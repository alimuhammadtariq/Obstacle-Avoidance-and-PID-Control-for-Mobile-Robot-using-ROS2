...
def movement():
    ...
    if regions_['fright']< 0.30 or regions_['right']< 0.30 :
    ...
    if regions_['front1']< 0.30 or regions_['front2']< 0.30 :
        fuzzy_instance = Fuzzyobstacleavoidance(regions_['front1'], regions_['front2'])  # iniate the Fuzzylogic controller with FRS and front back sensor
        x, y = fuzzy_instance
    msg = Twist()
